...
public class BarDisplay {
    ...
    public void draw(GuiGraphics guiGraphics, PoseStack poseStack, LivingEntity entity) {
        ...
        if (showModName && !modNameText.isBlank()) {
            guiGraphics.drawString(mc.font, modNameText, xOffsetM, 15 + ((barHeight == 0) ? barHeight - 2 : barHeight), getColor(0x5555ff, HealthIndicatorModConfig.MOD_NAME_COLOR.get()));
        }
    }
